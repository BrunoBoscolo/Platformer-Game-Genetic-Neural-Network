...
class RandomNeuralNetwork:
    ...
    def forward(self, inputs):
        ...
        hidden_layer_output = np.tanh(np.dot(inputs, self.input_weights) + self.input_biases)
        another_hidden_layer_output = np.tanh(np.dot(hidden_layer_output, self.hidden_weights) + self.hidden_biases)
